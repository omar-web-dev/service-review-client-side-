    ...
    return (
        <div>
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-100 dark:text-gray-900">
                ...
                <form onSubmit={(e)=> {e.preventDefault(); alert('Yeaaaaah!')}} novalidate="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                ...
                <div className="flex flex-col justify-between">
                    <img src="https://i.ibb.co/Svb4jjh/cont.jpg" alt="" className="mb-10" />
                </div>
            </div>
        </div>
    );
