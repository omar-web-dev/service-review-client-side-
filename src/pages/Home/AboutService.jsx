    ...
    return (
        <>
            <div className='my-28 text-center max-w-[992px] mx-auto'>
                ...
                <h2 className='py-4 md:px-[5%] text-[#191a1a] text-3xl md:text-5xl  md:leading-[65px] font-bold'>
                    “Use a picture. It’s worth a thousand words”- Tess Flanders.
                </h2>
                <p className='p-5'>Smart tools and techniques to create stunning designs, helping brands to communicate the right brand message to potential clients on different social groups and have a memorable positive impression. Connect with the professional graphic designers or illustrator designers of Esolz Technologies, the best graphic design agency in India, if you are looking for vehicle wrap design, digital art design, industrial graphic design, or any other creative graphic design services.</p>
                <div className='grid grid-cols-1 p-5  lg:grid-cols-2 mt-10 text-xl'>
                    <div className='text-left w-full'>
                        <h2 className='text-3xl my-2'>
                            We offer innovative graphic design services
                        </h2>
                        <h2>
