        ...
        <>
            <div className=' bg-gray-800 mt-5' >
                <div className='lg:flex items-center max-w-[1440px] mx-auto'>
                    <div className='lg:w-4/6 py-4 px-8 text-gray-100'>
                        <h2 className="  text-4xl mb-3">
                            {title}
                        </h2>
                    </div>
                    <div className='hidden lg:block w-2/4 text-gray-100 text-right'>
                ...
                <div className='block lg:flex p-10'>
                    <div className='lg:w-4/6  pt-9 '>
                        ...
                        <div className='mt-5 md:mt-10 lg-mt-14'>
                            ...
                            <div className='lg:hidden block w-full bg-orange-100 mx-auto text-center text-gray-100 '>
                    ...
                    <div className='lg:w-2/4  grid-cols-1 gap-5 '>
